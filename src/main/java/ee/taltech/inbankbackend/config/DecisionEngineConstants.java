...
public class DecisionEngineConstants {
    ...
    public static final Integer MAXIMUM_LOAN_PERIOD = 48; // the loan period is changed from 60 to 48 as given in the requirement .
    ...
    public static final Integer MAX_AGE_CUSTOMER = 70;
    public static final Integer MIN_AGE_CUSTOMER = 18;
}
